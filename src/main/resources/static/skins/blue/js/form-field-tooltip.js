...
DHTMLgoodies_formTooltip.prototype = {
	...
	__autoHideTooltip : function(e)
	{
		...
		if(src.tagName.toLowerCase()!='input' && src.tagName.toLowerCase().toLowerCase()!='textarea' && src.tagName.toLowerCase().toLowerCase()!='select' && src.tagName.toLowerCase()!='a')this.__hideTooltip();
	...
	{	
		...
		if(this.tooltipPosition=='below'){
			...
			this.tooltipDiv.style.top = (this.getTopPos(inputObj) - this.tooltipDiv.offsetHeight) + 'px';
		}else{
